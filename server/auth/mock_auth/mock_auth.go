...
func (mr *MockAuthHandlerMockRecorder) AddRecord(rec, secret, remoteAddr any) *gomock.Call {
...
func (mr *MockAuthHandlerMockRecorder) AsTag(token any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthHandlerMockRecorder) Authenticate(secret, remoteAddr any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthHandlerMockRecorder) DelRecords(uid any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthHandlerMockRecorder) GenSecret(rec any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthHandlerMockRecorder) GetResetParams(uid any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthHandlerMockRecorder) Init(jsonconf, name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthHandlerMockRecorder) IsUnique(secret, remoteAddr any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthHandlerMockRecorder) UpdateRecord(rec, secret, remoteAddr any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
